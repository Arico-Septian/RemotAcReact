...
<head>
    ...
    <style>
        /* ===== Profile page — responsive (laptop, tablet, mobile) ===== */
        ...
        .profile-identity .avatar-xl { width: 76px; height: 76px; border-radius: 999px; object-fit: cover; font-size: 28px; }
        .profile-identity-main { flex: 1; min-width: 0; }
        .profile-identity-aside { flex-shrink: 0; align-self: center; }
        .profile-identity .name { font-size: 20px; font-weight: 700; color: var(--ink-0); margin: 0; letter-spacing: -.01em; word-break: break-word; }
        ...
        .profile-info-value { font-size: 12px; color: var(--ink-0); margin: 0; line-height: 1.35; font-weight: 600; word-break: break-word; }
        ...
        .profile-logout .text { min-width: 0; flex: 1; }
        ...
        /* ===== Tablet (≤ 1023px) — narrower padding ===== */
        @media (max-width: 1023px) {
            .profile-shell { max-width: 100%; }
            .profile-shell .panel-lg { padding: 20px 22px; }
            .profile-identity { gap: 16px; }
            .profile-identity .avatar-xl { width: 72px; height: 72px; font-size: 26px; }
            .profile-identity .name { font-size: 19px; }
        }

        /* ===== Mobile L (≤ 640px) ===== */
        @media (max-width: 640px) {
            .profile-shell > .panel ~ .panel { margin-top: 12px; }
            .profile-shell .panel-lg { padding: 16px 18px; border-radius: 14px; }
            .profile-shell .panel-header { margin-bottom: 14px; }
            .profile-shell .panel-header .panel-title { font-size: 14px; }
            .profile-shell .panel-header .panel-subtitle { font-size: 11.5px; }

            .profile-identity { gap: 14px; }
            .profile-identity .avatar-xl { width: 64px; height: 64px; font-size: 22px; }
            .profile-identity .name { font-size: 17px; }
            .profile-identity .meta { font-size: 11px; gap: 6px; margin-top: 4px; }

            .profile-info-grid { gap: 6px; }
            .profile-info-label { font-size: 8.5px; }
            .profile-info-value { font-size: 11.5px; }

            .profile-pwd-grid { gap: 10px; }
            .profile-pwd-actions .btn { width: 100%; justify-content: center; }
            .profile-pwd-actions { justify-content: stretch; }

            .profile-logout .text h3 { font-size: 13px; }
            .profile-logout .text p { font-size: 11.5px; }
        }

        /* ===== Mobile M (≤ 480px) — identity wraps, info grid 2-col ===== */
        @media (max-width: 480px) {
            .profile-shell .panel-lg { padding: 14px 16px; }
            .profile-identity { flex-wrap: wrap; gap: 12px; }
            .profile-identity .avatar-xl { width: 60px; height: 60px; font-size: 20px; }
            .profile-identity .name { font-size: 16px; }
            .profile-identity-aside { width: 100%; margin-top: 4px; }
            .profile-identity .remove-photo { width: 100%; justify-content: center; padding: 8px 12px; }

            .profile-info-grid { grid-template-columns: 1fr 1fr; gap: 8px 12px; text-align: left; }
            .profile-info-grid > div + div { border-left: none; }
            .profile-info-grid > div { padding: 4px 0; }

            .profile-pwd-grid { grid-template-columns: 1fr; gap: 8px; }
        }

        /* ===== Mobile S (≤ 360px) — extra compact ===== */
        @media (max-width: 360px) {
            .profile-shell .panel-lg { padding: 12px 14px; border-radius: 12px; }
            .profile-identity { gap: 10px; }
            .profile-identity .avatar-xl { width: 54px; height: 54px; font-size: 18px; }
            .profile-identity .name { font-size: 15px; }
            .profile-identity .meta { font-size: 10.5px; }
            .profile-info-grid { grid-template-columns: 1fr; gap: 4px; }
            .profile-info-grid > div + div { padding-top: 8px; border-top: 1px solid var(--line-soft); }
            .profile-info-label { font-size: 8px; }
            .profile-info-value { font-size: 11px; }
            .profile-pwd-actions .btn { font-size: 12px; padding: 8px 12px; }
        }

        /* Header tweaks at small screens — sama dengan halaman lain */
        @media (max-width: 480px) {
            .main-header .app-header-title h1 { font-size: 16px; line-height: 1.2; }
            .main-header .app-header-title p { font-size: 11px; }
        }
        @media (max-width: 360px) {
            .main-header .app-header-title h1 { font-size: 13px; }
                                ...
                                <div class="field">
                                    ...
                                    <div class="profile-pwd-field">
                                        <input class="input" type="password" name="password" id="cp_new"
                                               placeholder="Min 8 + huruf + angka" required minlength="8" autocomplete="new-password">
                                ...
                                <div class="field">
                                    ...
                                    <div class="profile-pwd-field">
                                        <input class="input" type="password" name="password_confirmation" id="cp_confirm"
                                               placeholder="Ketik ulang" required minlength="8" autocomplete="new-password">
