                                    ...
                                    <div>
                                        <div class="dashboard-rooms-title-group">
                                            <div>
                                                ...
                                                <p class="dashboard-rooms-subtitle"><?php echo e($totalRooms); ?> rooms registered</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <section class="panel dashboard-activity-panel">
                                <div class="activity-header">
                                    <div>
                                        ...
                                        <p class="activity-subtitle"><?php echo e(count($recentActivities)); ?> recent activities</p>
                                    </div>
                                    <span class="activity-title-icon"><i class="fa-solid fa-bolt"></i></span>
                                </div>

                                <div class="activity-list" id="activityList">
                                    <?php $__empty_1 = true; $__currentLoopData = $recentActivities->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
