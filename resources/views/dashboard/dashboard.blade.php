                                ...
                                <div class="temp-chart-wrap" style="height:300px;position:relative;">
                                    ...
                                    <div id="tempChartEmpty" class="empty-state"
                                        ...
                                        <div style="text-align:center;">
                                            <div class="empty-icon"><i class="fa-solid fa-temperature-empty"></i>
                                            </div>
                                            <p class="empty-sub">No temperature data in the last 1 hour</p>
                                        </div>
                                    </div>
                                    <div id="tempChartLoading"
                                        style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:transparent;pointer-events:none;">
                                        <i class="fa-solid fa-spinner fa-spin"
                                            style="font-size:20px;color:var(--ink-4);opacity:0.5;"></i>
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            <div class="dashboard-rooms-title-group">
                                                <div>
                                                    ...
                                                    <p class="dashboard-rooms-subtitle">{{ $totalRooms }} rooms
                                                        registered</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if ($previewRooms->isNotEmpty())
                                        <div class="dashboard-room-list">
                                            @foreach ($previewRooms as $room)
                                                @php
                                                    $temperature =
                                                        $room->temperature ?? ($room->last_temperature ?? null);
                                ...
                                <section class="panel dashboard-activity-panel">
                                    <div class="activity-header">
                                        <div>
                                            ...
                                            <p class="activity-subtitle">{{ count($recentActivities) }} recent
                                                activities</p>
                                        </div>
                                        <span class="activity-title-icon"><i
                                        ...
                                        @forelse ($recentActivities->take(5) as $log)
                                            <div class="activity-item tone-{{ $log['tone'] }}">
                                                ...
                                                <div class="activity-avatar-wrap">
                                                    ...
                                                    @else
                                                        <div class="activity-avatar-fallback">
                                                            {{ $log['user_initial'] }}
                                                        </div>
                                                    @endif
