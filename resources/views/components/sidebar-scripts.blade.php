@auth
    ...
    <div id="idleWarnModal"
        ...
        <div
            style="max-width:380px;width:100%;background:var(--panel-1);border:1px solid var(--line);border-radius: 20px;padding:22px 22px 18px;box-shadow:0 20px 60px -20px rgba(0,0,0,0.6);">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">
                <span
                    style="width:36px;height:36px;border-radius:10px;background:rgba(251,191,36,0.14);border:1px solid rgba(251,191,36,0.34);display:inline-flex;align-items:center;justify-content:center;color:var(--amber);">
            ...
            <p style="margin:0 0 14px;font-size:13px;line-height:1.5;color:var(--ink-2);">
                ...
                <strong id="idleCountdown" style="color:var(--coral);font-family:'JetBrains Mono',monospace;">60</strong>
                seconds.
            </p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        setInterval(() => {
            if (!document.hidden) pollSidebarNotifBadge();
        }, 30000);
