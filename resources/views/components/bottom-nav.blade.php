...
<nav class="bottom-nav" style="display: none !important;">
    ...
    @endif
    @if ($role === 'admin')
        <a href="/logs" class="bnav-item {{ request()->is('logs*') ? 'active' : '' }}">
            <i class="fa-solid fa-clock-rotate-left"></i>
            <span>Activity</span>
        </a>
    @endif
    <a href="{{ route('monitoring') }}" class="bnav-item {{ request()->routeIs('monitoring') ? 'active' : '' }}">
        <i class="fa-solid fa-temperature-half"></i>
        <span>Server Temp</span>
    </a>
    <a href="/profile" class="bnav-item {{ request()->is('profile*') ? 'active' : '' }}">
