    ...
    <div id="notifPanel" class="notif-panel">
        <div class="notif-panel-header">
            <div>
                ...
                <p style="margin:2px 0 0;font-size:11px;color:var(--ink-3);"><span id="notifPanelCount">0</span> unread
                </p>
            </div>
        ...
        fetch('/notifications/recent', {
            ...
            .catch(() => {
                if (body) body.innerHTML =
                    '<div class="notif-empty"><i class="fa-solid fa-circle-exclamation"></i>Failed to load notifications</div>';
            });
    }
