                ...
                <div class="app-content">
                    <div class="app-content-inner space-y-4" style="max-width:720px;">
                        ...
                        <div class="tbl-wrap" style="padding:0;">
                            <div class="tbl-toolbar" style="border-bottom:1px solid var(--line-soft);">
                                <div class="app-header-title" style="margin:0;">
                                    <h1 style="font-size:13px;"><i class="fa-solid fa-circle-user"
                                            style="color:var(--cyan);margin-right:7px;"></i>Identity</h1>
                            ...
                            <div style="padding:16px;">
                                <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap;">
                                    ...
                                    <div style="flex:1;min-width:0;">
                                        <p
                                            style="margin:0;font-size: 18px;font-weight:700;color:var(--ink-0);word-break:break-word;">
                                            {{ $user->name }}</p>
                                        <div
                                            style="display:flex;align-items:center;gap:8px;margin-top:6px;flex-wrap:wrap;">
                                            <span class="badge-role {{ $user->role }}"
                                                style="padding:3px 10px;border-radius: 8px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;">{{ $user->role }}</span>
                                            <span style="font-size:12px;color:var(--ink-3);">Bergabung
                                                {{ $user->created_at->format('M Y') }}</span>
                                        </div>
                                    </div>
                                    @if ($user->avatar)
                                        <form method="POST" action="{{ route('profile.avatar.delete') }}"
                                            style="margin:0;" onsubmit="return confirm('Delete profile photo?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                style="display:inline-flex;align-items:center;gap:6px;padding:6px 12px;border-radius:8px;border:1px solid rgba(255,85,119,0.25);background:rgba(255,85,119,0.08);color:#ff5577;font-size:11px;font-weight:600;cursor:pointer;">
                                ...
                                <div class="profile-info-grid"
                                    style="margin-top:16px;border-top:1px solid var(--line-soft);padding-top:14px;">
                        ...
                        <div class="tbl-wrap" style="padding:0;">
                            <div class="tbl-toolbar" style="border-bottom:1px solid var(--line-soft);">
                                <div class="app-header-title" style="margin:0;">
                                    <h1 style="font-size:13px;"><i class="fa-solid fa-key"
                                            style="color:var(--cyan);margin-right:7px;"></i>Security</h1>
                            ...
                            <div style="padding:4px 16px 16px;">
                                ...
                                <form method="POST" action="/change-password" id="changePasswordForm"
                                    ...
                                    <div class="setting-row">
                                        ...
                                        <div class="pwd-field" style="width:200px;">
                                            <input class="input" type="password" name="current_password"
                                                ...
                                                autocomplete="current-password" style="width:100%;font-size:13px;">
                                            <button type="button" data-toggle="#cp_current" class="toggle-eye"
                                                title="Show/hide">
                                    ...
                                    <div class="setting-row">
                                        ...
                                        <div class="pwd-field" style="width:200px;">
                                            <input class="input" type="password" name="password" id="cp_new"
                                                ...
                                                autocomplete="new-password" style="width:100%;font-size:13px;">
                                            <button type="button" data-toggle="#cp_new" class="toggle-eye"
                                                title="Show/hide">
                                                <i class="fa-solid fa-eye text-[12px]"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="setting-row">
                                        ...
                                        <div class="pwd-field" style="width:200px;">
                                            <input class="input" type="password" name="password_confirmation"
                                                ...
                                                autocomplete="new-password" style="width:100%;font-size:13px;">
                                            <button type="button" data-toggle="#cp_confirm" class="toggle-eye"
                                                title="Show/hide">
                                                <i class="fa-solid fa-eye text-[12px]"></i>
                                            </button>
                                        </div>
                                    ...
                                    <p id="cpMatchHint"
                                        style="display:none;font-size:11px;color:#ff5577;margin:4px 0 0;">New passwords
                                        do not match</p>
                        ...
                        <div class="tbl-wrap" style="padding:0;">
                            <div
                                style="padding:14px 16px;display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">
                                <div>
                                    <p style="margin:0;font-size:13px;font-weight:700;color:var(--ink-0);">
                                        <i class="fa-solid fa-right-from-bracket text-[11px]"
                                            style="color:#ff5577;margin-right:6px;"></i>Sign Out
                                    </p>
                                    <p style="margin:3px 0 0;font-size:12px;color:var(--ink-3);">End the login session
                                        in this browser</p>
                                </div>
                                <form action="/logout" method="POST"
                                    ...
                                    <button type="submit" class="btn btn-soft"
                                        style="color:#ff5577;border-color:rgba(255,85,119,0.3);">
        ...
        (function() {
            ...
            form.addEventListener('submit', (e) => {
                ...
                if (submitBtn) {
                    ...
                    submitBtn.innerHTML =
                        '<i class="fa-solid fa-spinner fa-spin text-[11px]"></i><span>Menyimpan...</span>';
                }
            });
        })();
    </script>
